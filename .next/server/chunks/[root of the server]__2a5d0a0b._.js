...
const POST = async (request)=>{
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("INSERT INTO contact_info (email, name, comment) VALUES ($1, $2, $3) RETURNING *", [
            email,
            name,
            comment
        ]);
...
const GET = async ()=>{
    try {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("SELECT * FROM contact_info");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2a5d0a0b._.js.map